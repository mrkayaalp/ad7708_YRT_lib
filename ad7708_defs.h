...
#define AD7708_INTERFACE SPI1 //SPI'i büyük harfle yazmam problem yaratır mı?

#define COMM_REG_ADDR UINT8_C(0xF0)
typedef int8_t (*ad7708_com_fptr_t)(uint8_t reg_addr, uint8_t *data, uint16_t len);
...
typedef struct 
{
    uint8_t intf ; //TODO: declare interface and comm_add in init function
    CommReg commReg;
